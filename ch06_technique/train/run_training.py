# ch6_techs/train/run_training.py
import tqdm
import torch 
...
def training_loop(n_epochs, optimizer, model, loss_fn, train_loader, test_loader, device='cpu'):
    train_losses = []
    train_acc = []
    val_acc = []
...
def training_loop_l2reg(n_epochs, optimizer, model, loss_fn, train_loader, test_loader, device='cpu'):
    train_losses = []
    train_acc = []
    val_acc = []
    for epoch in range(n_epochs):
